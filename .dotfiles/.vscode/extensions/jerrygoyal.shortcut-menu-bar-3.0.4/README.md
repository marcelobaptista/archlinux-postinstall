![shortcut menu bar](https://github.com/GorvGoyl/Shortcut-Menu-Bar-VSCode-Extension/raw/HEAD/images/1.jpg)
...
![shortcut menu bar](https://github.com/GorvGoyl/Shortcut-Menu-Bar-VSCode-Extension/raw/HEAD/images/intro.png)
...
![shortcut menu bar](https://github.com/GorvGoyl/Shortcut-Menu-Bar-VSCode-Extension/raw/HEAD/images/settings.jpg)

## ✅ Currently added buttons

![shortcut menu bar](https://github.com/GorvGoyl/Shortcut-Menu-Bar-VSCode-Extension/raw/HEAD/images/all_buttons.png)
...
![User Buttons](https://github.com/GorvGoyl/Shortcut-Menu-Bar-VSCode-Extension/raw/HEAD/images/user-buttons.png)
...
3. Add any [VSCode command](https://code.visualstudio.com/docs/getstarted/keybindings#_default-keyboard-shortcuts) or any other extension command in the input field. Button icon will be visible only when you add a command.
   ...
   ![Add Command](https://github.com/GorvGoyl/Shortcut-Menu-Bar-VSCode-Extension/raw/HEAD/images/add-command.jpg)
